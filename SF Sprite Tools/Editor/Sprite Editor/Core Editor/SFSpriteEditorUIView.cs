...
namespace SFEditor.SpritesData
{
    ...
    public enum SpriteEditMode : ushort
    {
        NotEditing = 0,
        EditingRect = 1,
        CreatingRect = 2,
    ...
    public partial class SFSpriteEditor : EditorWindow
    {
        ...
        #region Mouse Drag 
        private SpriteEditMode _spriteEditMode;
        private Rect _mouseDragRect;

        private MouseRectDragManipulator _dragManipulator = new MouseRectDragManipulator(MouseButton.LeftMouse, 1f, EventModifiers.None);
        private MouseRectDragManipulator _panningManipulator = new MouseRectDragManipulator(MouseButton.LeftMouse, 1f, EventModifiers.Alt);
        private Vector2 _scrollPositionBeforePanning;
        #endregion
        ...
        private Vector2 _scrollSpeed = new Vector2(0.1f,0.1f);
        #endregion
        ...
        protected virtual void InitToolbar()
        {
            ...
            FloatField zoomInputField = new FloatField("Zoom")
            {
                value = _zoomLevel
            };
            zoomInputField.RegisterValueChangedCallback(OnZoomFieldChanged);

            void OnZoomFieldChanged(ChangeEvent<float> evt)
            {
                if (evt.newValue < 0.1)
                    return;
            ...
            SpriteEditorToolbar.Add(zoomInputField);
        ...
        private void InitializeUIAssets()
        {
            ...
            _rootContainer.styleSheets.Add(SFCommonStyleSheet);
        ...
        private void SetUpTextureView()
        {
            ...
            _panningManipulator.OnDragStartHandler += OnPanningStarted;
        ...
        private void SetTextureViewTransform()
        {
            ...
            TextureViewContainer.style.scale = new Vector3(_zoomLevel, _zoomLevel, 1);
            TextureViewContainer.style.translate = new Vector3(ScrollView.resolvedStyle.width / 2 ,0,0);
        }
        ...
        */
        ...
        protected virtual void ResetZoom()
        {
            ...
            TextureViewContainer.style.translate = ScrollPosition + new Vector2(ScrollView.resolvedStyle.width / 2, ScrollView.resolvedStyle.height / 2);
        }
        ...
        private void OnPanningMove(Rect rect)
        {
            ...
            _scrollPosition                      = _scrollPositionBeforePanning + _panningManipulator.DeltaPosition;
            TextureViewContainer.style.translate =  _scrollPosition;
            //Debug.Log($"Texture Container Translate: {TextureViewContainer.style.translate}, DeltaPosition: {_panningManipulator.DeltaPosition}");
        }
        
        private void OnPanningStarted(Rect obj)
        {
            _scrollPositionBeforePanning = _scrollPosition;
        }
